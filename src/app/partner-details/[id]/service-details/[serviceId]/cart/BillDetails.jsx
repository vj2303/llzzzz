      ...
      <div className='bg-white rounded-md p-3'>
        <div className='border-b mb-4'>
          ...
          <div className='flex justify-between'>
            <p className='font-medium text-[12px] flex gap-2 items-center'>
              Your Services
              {/* Toggle the Chevron icon */}
              {isOpen ? (
                <ChevronUp size={15} className='bg-gray-300 rounded-full' onClick={toggleVisibility} />
              ) : (
                <ChevronDown size={15} className='bg-gray-300 rounded-full' onClick={toggleVisibility} />
              )}
            </p>
          </div>
